...
const variants = {
    primary: 'bg-primary text-primary-foreground hover:opacity-75 hover:text-white',
    secondary: 'bg-secondary text-secondary-foreground hover:opacity-75 hover:text-white',
    ...
    glass: 'border-white/20 bg-white/10 px-3 py-1 text-xs text-white/70 hover:bg-white/20 hover:text-white',
}
